...
namespace Tidus_Miner
{
    ...
    {
        private readonly Runebook_old _owner;
        ...
        internal RunebookEntry(Runebook_old owner, GumpButton recall, GumpButton gate, GumpButton sacred, GumpButton scroll, GumpButton def, GumpButton drop, string location, string name, int color)
        {
            _owner = owner;
            _recall = recall;
            _gate = gate;
        ...
        internal RunebookEntry(Runebook_old owner, GumpButton recall, GumpButton gate, GumpButton sacred, GumpButton scroll, GumpButton def, GumpButton drop, string name)
        {
            _owner = owner;
            _recall = recall;
            _gate = gate;
    ...
    [QuerySearch(0x22C5)]
    public class Runebook_old : Item
    {
        ...
        public Runebook_old(Serial serial, RuneBookConfig config)
            : base(serial)
        {
            GumpType = 0x554B87F3;
            GumpDelay = 1000;
        ...
        public Runebook_old(Serial serial, RuneBookConfig config, uint gumptype)
            : base(serial)
        {
            GumpType = gumptype;
            GumpDelay = 1000;
        ...
        public Runebook_old(Serial serial, RuneBookConfig config, string osi)
            : base(serial)
        {
            GumpType = 0x0059;
            GumpDelay = 1000;
        ...
        public Runebook_old(uint value, RuneBookConfig config)
            : this(new Serial(value), config)
        { }
        public Runebook_old(uint value, RuneBookConfig config, string osi)
